...
import runGuest from './../../modules/runGuestSession';
import getRate from './../../modules/getRatedMovies';
...
runGuest((arg) => guest_session_id = arg );
  ...
  return (
    <div className="movie-app">
      <div className="main">
        ...
        { !mode ?
        <CardListRouted curData={curData} guestSessionId={guest_session_id}/>
        :
        null 
       }
